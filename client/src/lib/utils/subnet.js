...
export function calculateSubnetInfo(networkAddress, maskBits) {
...
export function divideSubnet(networkAddress, currentMask, newMask) {
...
export function areAdjacent(subnet1, subnet2) {
...
export function exportToCSV(subnets, visibleColumns) {
